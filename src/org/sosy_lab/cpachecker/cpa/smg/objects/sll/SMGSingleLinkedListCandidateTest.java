...
public class SMGSingleLinkedListCandidateTest {
  ...
  public void executeOnSimpleList() throws SMGInconsistentException {
    ...
    CLangSMG abstractedSmg = candidateSeq.execute(smg, new SMGState(LogManager.createTestLogManager(), MachineModel.LINUX64, false, false, null, 4, false, false, false));
